...
async def generate_lecture_from_topics(
    ...
    # ============================================================================
    # NOTE: Lecture is already saved to database by lecture_repository.create_lecture()
    # No need to save again here - just print confirmation
    # ============================================================================
    ...
    print(f"{'='*60}")
    print(f"Lecture UID: {lecture_id}")
    print(f"Material ID: {material_snapshot.get('id')}")
    print(f"Admin ID: {material_snapshot.get('admin_id')}")
